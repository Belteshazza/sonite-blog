        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $second_post->featured }}" style="width: 500px;height:auto; alt="seo">
                            <div class="overlay"></div>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $third_post->featured }}" style="width: 500px;height:auto; alt="seo">
                            <div class="overlay"></div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ $post->featured }}" style="width: 100;height:auto; alt="our case">
                                        </div>
